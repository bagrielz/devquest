...
CREATE TABLE question (
    ...
    technology VARCHAR(255) CHECK (technology IN (
        ...
        'CHAI', 'JEST', 'CUCUMBER', 'KARMA', 'PROTRACTOR', 'WEB3_JS', 'ETHERS_JS', 'SOLIDITY', 'TRUFFLE',
        'HARDHAT', 'GANACHE', 'METAMASK', 'VERCEL', 'NETLIFY', 'HEROKU', 'DIGITAL_OCEAN', 'LINODE', 'VULTR',
        'FIREBASE', 'SUPABASE', 'BACK4APP', 'STRAPI', 'CONTENTFUL', 'WORDPRESS', 'DRUPAL', 'JOOMLA', 'MAGENTO',
